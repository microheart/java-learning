 ...
 * 动态代理性能比较
 *
 * JDK Proxy, CGLIB Proxy, JavaAssist Proxy, JavaAssist Bytecode Proxy, ASM Proxy
 *
 * 在不同JDK版本下性能有差异，JDK高版本对JDK Proxy进行了较好的优化，与CGLIB差异并不大。
 *
 * 在Spring中，AOP的反射主要有两种策略：一是JDK的反射；一是CGLIB
 *
 */
public class DynamicProxyPerformanceCompDemo {
    ...
    private static class CountServiceImpl implements CountService {
        private int count = 0;
    ...
    private static CountService createJavassistBytecodeDynamicProxy(final CountService delegate) throws Exception {
